...
var hasProductFileAccess = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
                ...
                purchasedProductFileIds = orders
                    ...
                    return order.products.map(function (prod) {
                        if (typeof prod === "string") {
                            return req.payload.logger.error("Insufficient search depth for purcharsed file IDs");
                        }
