...
var query_validator_1 = __importDefault(require("../lib/validators/query-validator"));
...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        query: query_validator_1.default,
    }))
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var query, cursor, sort, limit, queryOpts, payload, parsedQueryOpts, page, _c, products, hasNextPage, nextPage;
        var input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _c = _d.sent(), products = _c.docs, hasNextPage = _c.hasNextPage, nextPage = _c.nextPage;
                    return [2 /*return*/, {
                            products: products,
