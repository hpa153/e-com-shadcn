...
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        ...
        var email, password, confirmedPassword, payload, users;
        var input = _b.input;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    email = input.email, password = input.password, confirmedPassword = input.confirmedPassword;
                ...
                case 2:
                    ...
                    if (password !== confirmedPassword) {
                        throw new server_1.TRPCError({ code: "PRECONDITION_FAILED" });
                    }
                    // Create new user
    ...
    signIn: trpc_1.publicProcedure
        .input(account_credentials_validator_1.LoginCredentialsValidator)
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
